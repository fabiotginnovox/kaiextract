...
export const AVAILABLE_GROUNDING_FIELDS = [
  ...
  { field: 'proxima_leitura', label: 'Próxima Leitura', defaultColor: '#818CF8', category: 'Datas' },
  { field: 'leitura_atual', label: 'Leitura Atual', defaultColor: '#A78BFA', category: 'Datas' },
  { field: 'numero_medidor', label: 'Nº Medidor', defaultColor: '#60A5FA', category: 'Documento' },
  ...
  { field: 'protocolo_autorizacao', label: 'Protocolo de Autorização', defaultColor: '#60A5FA', category: 'Documento' },
